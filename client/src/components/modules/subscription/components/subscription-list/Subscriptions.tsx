import { Button, DataGrid, Loader, PageTitle } from '../../../../../shared/components';
    ...
    const actionRender = (data: any) =>{
        return !data.isTreated ? (
            <>
                ...
                <Button title="Delete" rounded onClick={() => onReject(data._id)} color="secondary">
                    <FaTimes size="14px" />
                </Button>
            </>
        ) : null
