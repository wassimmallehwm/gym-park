...
const Navbar = ({
    ...
    return (
        <header className="bg-primary-400 shadow-md h-12 flex items-center justify-center fixed w-full z-30">
            <div className="flex flex-grow items-center justify-between px-3">
                ...
                {/* <Menu as="div" className="ml-3 relative">
                    ...
                    >
                        <Menu.Items className="origin-top-right z-10 absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-slate-100 ring-1 ring-black ring-opacity-5 focus:outline-none">
